...
<body>
	...
	<article>
		...
		<div class="create_word"><h1>建立您的帳號</h1></div>

		<div class=formblock>

        <form name="form1" method="post" action="../register_check.jsp" style="margin: 20px auto;text-align: center;">
        	
	       		<div class="leftside">
			       <input class="formfont" type="text" name="acc" width="50" height="20" placeholder="帳號"><br>
			       <input class="formfont" type="password" name="pwd" width="50" height="20" placeholder="密碼"><br>
			       <input class="formfont" type="text" name="firstname" width="50" height="20" placeholder="姓氏"><br>
				...
				<div class="rightside">
			       ...
			       <input class="formfont" id="mailtxt" type="text" name="mail" width="50" height="20" placeholder="電子信箱"><br>
			       <input class="formfont" type="text" name="lastname" width="50" height="20" placeholder="名字"><br>
			       <input class="formfont" type="text" name="phone" width="50" height="20" placeholder="電話"><br>
			     </div>
			 <div style="clear: both;"></div>

	       <button type="submit" class="namebt"name="signup"onclick="check()">確定註冊</button>
	    </form>
    </div>
